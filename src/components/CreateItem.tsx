...
const CreateItem = forwardRef<HTMLDialogElement, AnimalFormDialogProps>(
  ({ onSubmit, onCancel, editingItem }, ref) => {
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className="w-full md:w-1/2 px-3 mt-2">
              ...
              <select
                ...
                <option>none</option>
                {files.map((file: File) => (
                  <option key={file.imgName} value={file.link}>
                    {file.imgName}
                  </option>
                ))}
              </select>
