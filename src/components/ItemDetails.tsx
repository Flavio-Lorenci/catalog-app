...
const ItemDetails = forwardRef<HTMLDialogElement, AnimalFormDialogProps>(({animal, onCancel}, ref) => {
        const controlValue = ['name', 'species', 'family', 'habitat', 'placeOfFound', 'diet', 'description', 'weightKg', 'heightCm'];
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div key={el} className="w-full md:w-1/2 px-3 mt-2">
                        ...
                        <input
                            ...
                            id="name" type="text" value={animal[el]} disabled
                        />
                    </div>
                    )}
                </div>
